...
export default function HelpPage() {
  return (
    <main className="flex min-h-screen flex-col bg-blue-50 px-4 py-12 text-slate-800">
      ...
      <Link href="/" className="mt-8 text-sm font-semibold text-blue-500 underline-offset-4 hover:underline">
